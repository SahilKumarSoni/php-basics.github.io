            ...
            <div class="bg-[#fff] rounded-xl form w-full p-4">
                <form action="">
                    ...
                    <div class="form-group mt-2 flex flex-col items-left font-semibold">
                        ...
                        <input type="text" id="mobile" name="mobile" placeholder="Enter Mobile Number:" required class="border rounded-sm p-2">
                    </div>
                    <div class="form-group mt-2 flex flex-col items-left font-semibold">
                    ...
                    <div class="form-group mt-2 flex flex-col items-left font-semibold">
                        <label for="uname" class="ml-1">User Name <span><sup class="text-red-500">*</sup></span></label>
                        <input type="text" id="uname" name="uname" placeholder="Enter a User Name:" class="border rounded-sm p-2">
                    </div>
                    <div class="form-group mt-2 flex flex-col items-left font-semibold">
                    ...
                    <div class="flex flex-col justify-center items-center">
                        <div class=" text-center bg-[#87CEEB] mt-5 btn text-lg font-bold p-2 rounded-lg shadow-[rgba(6,_24,_44,_0.4)_0px_0px_0px_2px,_rgba(6,_24,_44,_0.65)_0px_4px_6px_-1px,_rgba(255,_255,_255,_0.08)_0px_1px_0px_inset]">
